...
def init_classes(d_type):
    ...
    MtImageLocation._fields_ = [('x', ct.c_int16), ('y', ct.c_int16)]

    MtPixel._fields_ = [('location', MtImageLocation), ('value', pixel_type)]
    ...
    MtNodeAttributes._fields_ = [('volume', float_type), ('power', float_type)]

    MtNode._fields_ = [('parent', ct.c_int32), ('area', ct.c_int32)]
    ...
    MtObjectData._fields_ = [
        ...
        ('node_significance_test_data_free', ct.CFUNCTYPE(ct.c_void_p, ct.POINTER(MtObjectData))),
    ]
