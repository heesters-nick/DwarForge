...
from dwarforge.sqlite_utils import retry_on_db_locked  # noqa: E402
from dwarforge.utils import (  # noqa: E402
    ensure_list,
    extract_tile_numbers_from_job,
    get_dwarf_tile_list,
)


def init_db(database: Path):
...
def init_cutouts_db(database: Path):
...
def get_unprocessed_jobs(
    ...
    try:
        ...
        # test_tiles = [
        #     (np.int64(77), np.int64(337)),
        #     (np.int64(88), np.int64(309)),
        #     (np.int64(116), np.int64(316)),
        #     (np.int64(133), np.int64(284)),
        #     (np.int64(135), np.int64(291)),
        #     (np.int64(137), np.int64(291)),
        #     (np.int64(138), np.int64(304)),
        #     (np.int64(144), np.int64(295)),
        #     (np.int64(156), np.int64(271)),
        #     (np.int64(172), np.int64(261)),
        #     (np.int64(175), np.int64(305)),
        #     (np.int64(199), np.int64(319)),
        #     (np.int64(214), np.int64(288)),
        #     (np.int64(241), np.int64(270)),
        #     (np.int64(252), np.int64(253)),
        #     (np.int64(257), np.int64(252)),
        #     (np.int64(273), np.int64(302)),
        #     (np.int64(292), np.int64(239)),
        #     (np.int64(310), np.int64(239)),
        #     (np.int64(314), np.int64(266)),
        #     (np.int64(364), np.int64(272)),
        #     (np.int64(392), np.int64(269)),
        #     (np.int64(444), np.int64(250)),
        #     (np.int64(455), np.int64(239)),
        #     (np.int64(455), np.int64(245)),
        #     (np.int64(460), np.int64(243)),
        #     (np.int64(177), np.int64(257)),
        #     (np.int64(144), np.int64(301)),
        #     (np.int64(137), np.int64(299)),
        #     (np.int64(272), np.int64(239)),
        #     (np.int64(200), np.int64(289)),
        # ]
        # test_tiles = np.loadtxt('tables/missing_tiles.txt', dtype=str)
        # test_tiles = [(int(x.split('_')[0]), int(x.split('_')[1])) for x in test_tiles]
        # 300_267, 274_281, 356_241, 328_239, 288_240, 291_266, 251_287, 115_317, 105_321, 221_246, 241_289, 128_311
        # test_tiles = [
        #     (np.int64(300), np.int64(267)),
        #     (np.int64(274), np.int64(281)),
        #     (np.int64(214), np.int64(273)),
        #     (np.int64(356), np.int64(241)),
        # (np.int64(328), np.int64(239)),
        # (np.int64(288), np.int64(240)),
        # (np.int64(291), np.int64(266)),
        # (np.int64(251), np.int64(287)),
        # (np.int64(115), np.int64(317)),
        # (np.int64(105), np.int64(321)),
        # (np.int64(221), np.int64(246)),
        # (np.int64(241), np.int64(289)),
        # (np.int64(128), np.int64(311)),
        # ]
        ...
        if 'test_tiles' in locals() and test_tiles is not None and len(test_tiles) != 0:
            ...
            test_tiles = [tile for tile in test_tiles if tile in tiles_to_process]  # type: ignore
